...
| v0.6    | Now    | Follow a rotating routine with resurfacing         | Spaced resurfacing, Suggested routine                               | v0.5, for modes to rotate. Persistence and run modes, so real reps are saved to resurface                      |

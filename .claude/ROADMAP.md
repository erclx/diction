...
| v0.5    | Now    | Practice rhythm and intonation against a reference | Shadowing, Stress and intonation drills                             | v0.1, for the audio pipeline. Calibrated score thresholds, so shadowing and prosody scores read as trustworthy |
| v0.6    | Next   | Follow a rotating routine with resurfacing         | Spaced resurfacing, Suggested routine                               | v0.5, for modes to rotate. Persistence and run modes, so real reps are saved to resurface                      |

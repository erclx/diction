...
- [Minimal pair production](minimal-pair-production.md): The production drill surface where the user says one word of a minimal pair and sees a sound-quality score for the target
